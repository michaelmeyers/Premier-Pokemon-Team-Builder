...
//    convenience init?(dicitionary: [String: Any], pokemon: Pokemon) {
//        guard let namesArray = dicitionary[Keys.namesArrayKey] as? [[String: Any]],
//            let englishNameDictionary = namesArray[Keys.englishNameDictionaryKey] as? [String: Any],
//            let name = englishNameDictionary[Keys.moveNameKey],
//            let typeDictionary = dicitionary[Keys.moveTypeDictionaryKey] as? [String: Any],
//            let type = typeDictionary[Keys.moveTypeKey] as? String,
...
//            let effectArray = dicitionary[Keys.effectArrayKey] as? [[String: Any]],
//            let effectDictionary = effectArray[Keys.effectDictionaryKey] as? [String: Any],
//            let description =  effectDictionary[Keys.descriptionKey] as? String else {return nil}
//
